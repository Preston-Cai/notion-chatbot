...
Next step: 
1. Implement mechanisms to catch and save failed-to-scrape links to error_links.csv. 
    Error message example:
    An error occurs when getting html or baking soup. Error:  Page.goto: Timeout 30000ms exceeded.
    Call log:
    - navigating to "https://utat-ss.notion.site/20cf603ca95d4a0c90b90fd0276b563f", waiting until "domcontentloaded"
...
class SoupsMaker():
    ...
    async def get_html(self, url: str, page: Optional[Page] = None) -> str:
        """Return html document for a given url. Call self.save_html() to save htmls.
    ...
    def save_html_and_text(self, soup: BeautifulSoup) -> None:
        """Save prettified html files and extracted text file."""
    ...
    def _start_by_mode(self) -> None:
        ...
        if not self.resume:
            ...
            # Confirmed fresh mode
                ...
                # Clear existing html and text docs
