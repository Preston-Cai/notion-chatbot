...
class SoupsMaker():
    ...
    def add_all_links(self) -> None:
        ...
        while self.to_visit:
            ...
            # debug only
            lists_of_links = [self.process_link(url_this_time=batch.pop())]
...
def run_soupsmaker(starting_url: tuple[str, str] = (URL, BASE_URL),
                 cap: int = 10, resume: bool = False) -> None:
...
if __name__ == '__main__':
    run_soupsmaker(cap=1, resume=False, starting_url=(URL, BASE_URL))
