"""
NOTE: it turns out that the attempt of this version is not necessary (and didn't fix the right issue).
Try6 failed not due to the reason we expected. See try6 docstring for details.s
